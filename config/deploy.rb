server '107.167.190.250', port: 22, roles: [:web, :app, :db], primary: true

set :repo_url,        'git@github.com:solegiter/kindness.git'
set :application,     'kindness'

set :user,            'realseniordev210'
...
namespace :deploy do
  ...
  # before 'deploy:compile_assets', :install
